...
$.fn.dirBrowser = function(inParam) {
    return this.each(function(){
        ...
        {
            $div.html('<div style="padding:2em; text-align:center"><img src="'+param.rootUrl + '/application/default/views/public/img/ajax-loader.gif"></div>');
        ...
        function drawBrowser(data)
        {
            return $('<div></div>').append(
                    ...
                    "<br /><i>Click radio-button to choose a directory</i>"
