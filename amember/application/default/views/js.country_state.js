...
foreach (array('US', 'CA') as $c)
    echo "statesCache.".$c." = " . Am_Controller::getJson(Am_Di::getInstance()->stateTable->getOptions($c)) . ";\n";
?>
</script>
...
jQuery(document).ready(function($) {
    ...
    function onCountryChange() {
        ...
        selectState.append($('<option></option').val('').html(<?php echo Am_Controller::getJson(___('[Select state]')) ?>));
